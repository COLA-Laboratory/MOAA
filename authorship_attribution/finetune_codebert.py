...
class TextDataset(Dataset):
            ...
            with open(file_path) as f:
                for line in f:
                    ...
                    self.examples.append(
                        convert_examples_to_features(code, int(label), tokenizer, args)
                    )
    ...
    def __getitem__(self, item):
        ...
        return torch.tensor(self.examples[item].input_ids), torch.tensor(
...
def main():
    ...
    model = CodeBERTModelModel(model, config, tokenizer, args)
