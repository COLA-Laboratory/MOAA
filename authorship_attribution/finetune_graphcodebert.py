...
from model import GraphCodeBERTModel
...
class InputFeatures(object):
    ...
    def __init__(
        self, input_tokens, input_ids, position_idx, dfg_to_code, dfg_to_dfg, idx, label
    ):
...
def convert_examples_to_features(js, tokenizer, args):
    ...
    code_tokens = code_tokens[
        ...
        - 2
        - min(len(dfg), args.data_flow_length)
    ]
...
def main():
    ...
    model = GraphCodeBERTModel(model, config, tokenizer, args)
