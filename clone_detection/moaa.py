...
class MOAA:
    ...
    def attack(self, idx, orig_code1, orig_code2, label):
        ...
        is_success = 0
        identifiers, code_tokens = get_identifiers(orig_code1, "java")
        ...
        if orig_label != label:  # the original code is misclassified
            ...
            for i in range(self.pop_size):
                self.parent_pop.indi.append(
                    Individual(
                        code_tokens, identifiers, pos_dict, orig_label, orig_code2
                    )
                )
                ...
                if flag_success == False:
                    query_times += 1
                    if (
                        self.parent_pop.indi[i].label_ != orig_label
